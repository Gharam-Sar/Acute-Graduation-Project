          ...
          children: <Widget>[
            new ClipPath(
              child: new Container(
                decoration: BoxDecoration(
                  color: Color.fromARGB(255, 71, 104, 158).withOpacity(0.5),
                  ...
                  gradient: LinearGradient(
                    colors: [
                      Color.fromARGB(255, 71, 104, 158).withOpacity(0.2),
                      Color.fromARGB(255, 71, 104, 158).withOpacity(0.5)
                    ],
            ...
            new ClipPath(
              child: new Container(
                decoration: BoxDecoration(
                  ...
                  gradient: LinearGradient(
                    colors: [
                      Color.fromARGB(255, 71, 104, 158).withOpacity(0.4),
            ...
            Column(
              children: <Widget>[
                AspectRatio(
                  aspectRatio: 1,
                  child: Image.asset("assets/others/bottle.png"),
                ),
              ],
            )
          ],
