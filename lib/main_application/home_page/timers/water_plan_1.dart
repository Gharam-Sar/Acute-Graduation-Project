...
class water_plan_1 extends StatefulWidget {
  List firstlist;
  water_plan_1({Key? key, this.animationController, required this.firstlist})
      : super(key: key);

  final AnimationController? animationController;
  @override
  _water_plan_1State createState() => _water_plan_1State();
}

class _water_plan_1State extends State<water_plan_1> {
  List checked_drink = [
    false,
    false,
    false,
