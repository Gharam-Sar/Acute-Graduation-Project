   ...
   <aside style="background-color: #0b1a34;" class="sidenav  navbar-vertical navbar-expand-xs  border-radius-xl fixed-start ms-2 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse    max-height-vh-100" id="sidenav-collapse-main">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
      <a style="background-color: #b6d9f0; "class="nav-link text-white " href="./feed-back.php">
        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
          <i class="material-icons opacity-10"style="background-color:#0b1a34; ">assignment</i>
        </div>
        <span class="nav-link-text ms-1"style="color:#0b1a34;">Feed Back</span>
      </a>
    </li>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class=" border-radius-lg pt-4 pb-3"style="background-color: #0b1a34; color: white;">
                <h6 class="text-white text-capitalize ps-3">Acute Users Feed Back</h6>
              </div>
            </div>
              ...
              <div class="table-responsive p-0"  align = "center";>
                <table class="table align-items-center mb-0" align = "center";>
                  <thead  align = "center";>
                    ...
                    <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7 ps-2">Feed Back</th>              
